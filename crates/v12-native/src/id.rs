...
pub enum NativeId {
    ...
    StringToWellFormed = 1232,
    StringIsWellFormed = 1233,
    StringMatchAll = 1234,
    StringRaw = 1235,
    StringAnchor = 1236,
    StringBig = 1237,
    ...
    StringSup = 1248,
    StringTrimLeft = 1249,
    StringTrimRight = 1250,
    StringToLocaleLowerCase = 1251,
    StringToLocaleUpperCase = 1252,
    ...
    EvalErrorCreate = 1607,
    UriErrorCreate = 1608,
    ErrorIsError = 1609,
    ErrorProtoToString = 1610,
